infoJSON = "([   {'desc':'人称代词；主语、谓语、宾语；查词典', 'files':[ {'address': '../static/raw/pdf/2023暑期英语练习(1).pdf', 'name': '2023暑期英语练习(1) 题目.pdf'} , {'address': '../static/raw/pdf/2023暑期英语练习(1) 答案.pdf', 'name': '2023暑期英语练习(1) 答案.pdf'} , {'address': '../static/raw/audio/2023暑期英语练习(1) 听力材料.mp3', 'name': '2023暑期英语练习(1) 听力材料.mp3'} ]},       {'desc':'动词变形及时态', 'files':[ {'address': '../static/raw/pdf/2023暑期英语练习(2).pdf', 'name': '2023暑期英语练习(2) 题目.pdf'} , {'address': 'none', 'name': '2023暑期英语练习(2) 答案.pdf'}, {'address': '../static/raw/audio/动词变形及时态 课堂录音(1).mp3', 'name': '动词变形及时态 课堂录音(1).mp3'}, {'address': '../static/raw/audio/动词变形及时态 课堂录音(2).mp3', 'name': '动词变形及时态 课堂录音(2).mp3'}, {'address': '../static/raw/audio/动词变形及时态 课堂录音(3).mp3', 'name': '动词变形及时态 课堂录音(3).mp3'}, {'address': '../static/raw/audio/动词变形及时态 课堂录音(4).mp3', 'name': '动词变形及时态 课堂录音(4).mp3'}, {'address': '../static/raw/audio/动词变形及时态 课堂录音(5).mp3', 'name': '动词变形及时态 课堂录音(5).mp3'}   ]}       ])";
